...
//
// RTL revision : 4FE-safe-v68a
// Experiment   : E068A-R32-retirement-credit-only
// Based on     : 4FE-safe-v20 / E021-N1
// Changes      : consume actual retirement progress in the BKPR decision only
//
...
module ff_rob #(
  ...
  // Retirement-only ablation: credit only the entries guaranteed to retire at
  // this edge. Keep the issue-window safety threshold fixed at WIN_TH=17.
  // Convert the retirement thermometer to a one-hot count (0..4), then select
  // fixed threshold comparisons in parallel.
